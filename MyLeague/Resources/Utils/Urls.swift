...
class Urls: NSObject {
   ...
   static let CHAMPIONS_LIST : String = "http://ddragon.leagueoflegends.com/cdn/6.24.1/data/en_US/champion.json"
   static let CHAMPIONS_LIST_FREE : String = "https://euw1.api.riotgames.com/lol/platform/v3/champions?freeToPlay=false"
    
    
    
    static let CHAMPION_PICTURE : String = "https://ddragon.leagueoflegends.com/cdn/7.10.1/img/champion/"
